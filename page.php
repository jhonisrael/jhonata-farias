		...
		<div class="container">
			<nav class="menu-principal">
				<ul>
					...
					<li>
						<a href="#box3">Serviços</a>
					</li>
					<li>
						<a href="#box4">Contato</a>
					</li>
					<li>
			...
			<header>
			<img class="img_tamanho" src="./css/1614346924348.jpg" alt="Foto De Perfil" class="photo">
            </header>

			<section id="box1" class="apresentacao">
				<h1>Olá</h1>
				<h1>Meu nome é Jhonata Farias</h1>
				<h3>Sou <span class="destaque">Desenvolvedor Web</span> Back-End, Com Bons Conhecimentos Do Front-End.</h3>
				<h3> Veja o que tenho feito no link abaixo do meu GitHub:
					<div><a href="https://github.com/jhonisrael"><img src="https://img.shields.io/badge/GitHub-100000?style=for-the-badge&logo=github&logoColor=white"></a>
						</div>
				</h3>
			</section>
